 ...
 * </pre>
 */
public class Encodes implements Constant {
    ...
    public static String encodeBase64(String input) {
        try {
            return new String(Base64.encodeBase64(input.getBytes(CHARSET_UTF_8)));
    ...
    public static String decodeBase64String(String input) {
        try {
            return new String(Base64.decodeBase64(input.getBytes()), CHARSET_UTF_8);
        } catch (UnsupportedEncodingException e) {
            return "";
        }
    }
